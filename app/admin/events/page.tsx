      ...
      <Card>
        ...
        <CardContent className="space-y-4">
            ...
            <div className="flex-1">
              <label htmlFor="excel-upload-events" className="cursor-pointer">
                ...
                <Button
                  ...
                  onClick={() =>
                    document.getElementById("excel-upload-events")?.click()
                  }
                >
          ...
          <p className="text-sm text-muted-foreground">
            Download the template, fill in your events data, and upload the
            Excel file to import multiple events at once.
          </p>
        </CardContent>
      </Card>
