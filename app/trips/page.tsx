...
export default function TripsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"suggestions" | "plans">(
    "suggestions",
  );
  ...
  const shareTrip = async (tripData: any, type: "plan" | "suggest") => {
    ...
    if (type === "plan" && tripData.result?.destinations?.length > 0) {
      ...
      if (destinations.length === 1) {
        ...
        const encodedDestinations = destinations.map((dest: string) =>
      ...
      const allDestinations = suggestions.map(
        (s: any) => `${s.destination}, ${s.state}, India`,
      );
      ...
      if (allDestinations.length === 1) {
        ...
        const encodedDestinations = allDestinations.map((dest: string) =>
          encodeURIComponent(dest),
        );
        const origin = encodedDestinations[0];
        const destination = encodedDestinations[encodedDestinations.length - 1];
  ...
  return (
    <div
      className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 py-6 sm:py-8 md:py-10"
              ...
              {activeTab === "plans" && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="text-mobile-xl font-semibold">
                      ₹{t.result?.totalBudget?.toLocaleString?.() || "-"}
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="text-mobile-sm text-muted-foreground">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div className="border border-blue-200 bg-blue-50 rounded-lg p-4 shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-blue-600 font-medium">
                            {
                              t.result.preferenceAnalysis.interestsCoverage
                                .coveragePercentage
                            }
                            % Match
                          </div>
                      ...
                      <div className="space-y-2">
                        {t.result.preferenceAnalysis.interestsCoverage.matchedInterests
                          .slice(0, 2)
                    ...
                    <div className="border border-green-200 bg-green-50 rounded-lg p-4 shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-green-600 font-medium">
                            {
                              t.result.preferenceAnalysis.dietaryCompliance
                      ...
                      <div className="space-y-2">
                        {t.result.preferenceAnalysis.dietaryCompliance.restrictions
                          .slice(0, 2)
                          .map((restriction: string, idx: number) => (
                            <div
                              key={idx}
                    ...
                    <div className="border border-purple-200 bg-purple-50 rounded-lg p-4 shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-purple-600 font-medium">
                            {
                              t.result.preferenceAnalysis
                                .accessibilityCompliance.compliancePercentage
                            }
                            % Accessible
                          </div>
                        </div>
                      ...
                      <div className="space-y-2">
                        {t.result.preferenceAnalysis.accessibilityCompliance.requirements
                          .slice(0, 2)
                        ...
                        {t.result.preferenceAnalysis.accessibilityCompliance
              ...
              {activeTab === "plans" && t.result?.attractions?.length > 0 && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {(expandedTripCard === t.id
                      ? t.result.attractions
                      : t.result.attractions.slice(0, 2)
                    ).map((p: any, i: number) => (
                      <div
                        key={i}
                        className="border border-muted/50 rounded-lg p-4 text-sm bg-background/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300"
                      >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      onClick={() =>
                        setExpandedTripCard(
                          expandedTripCard === t.id ? null : t.id,
                        )
                      }
                      variant="outline"
                      size="sm"
                  ...
                  {t.result?.destinations?.length > 0 && (
                    <div className="pt-4 border-t space-y-3">
                      <Button
                        onClick={() => {
                          ...
                          if (destinations.length === 1) {
                            ...
                            window.open(
                              `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(destinations[0])}, India`,
                              "_blank",
                            );
                          } else if (destinations.length > 1) {
                            // Multiple destinations - create route
                            const encodedDestinations = destinations.map(
                              (dest: string) => encodeURIComponent(dest),
                            );
                            const origin = encodedDestinations[0];
                            const destination =
                              encodedDestinations[
                                encodedDestinations.length - 1
                              ];
                            const waypoints = encodedDestinations.slice(1, -1);
                      ...
                      >
                        ...
                        View All Routes ({t.result.destinations.length}{" "}
                        destinations)
                      </Button>
                        ...
                        <Button
                          onClick={() => {
                            ...
                            if (destinations.length === 1) {
                              ...
                              const waypoints = encodedDestinations.slice(
                                1,
                                -1,
                              );
                        ...
                        <div className="text-xs text-muted-foreground">
                          <div className="flex items-center justify-between">
                            ...
                            <span>
                              ...
                              meals • {t.result.roadmap.length} days
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="space-y-1">
                      ...
                      <div className="text-lg font-semibold text-foreground">
                        ₹{t.input.budgetINR?.toLocaleString()}
                      </div>
                    </div>
                  </div>
                  ...
                  {t.input?.includeAccommodation && t.input?.budgetAnalysis && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 bg-muted rounded-lg">
                      <div className="space-y-1">
                        ...
                        <div className="text-lg font-semibold text-foreground">
                          ₹
                          {t.input.budgetAnalysis.accommodationBudget?.toLocaleString()}
                        </div>
                        <div className="text-xs text-muted-foreground">
                          40% of total
                        </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-lg font-semibold text-foreground">
                          ₹
                          {t.input.budgetAnalysis.activityBudget?.toLocaleString()}
                        </div>
                        <div className="text-xs text-muted-foreground">
                          60% of total
                        </div>
                      ...
                      <div key={i} className="relative card-container">
                        ...
                        >
                          <CardContent className="pt-4 sm:pt-6 space-y-2 sm:space-y-3 flex flex-col h-full p-mobile">
                            <div className="flex-1 space-y-2 sm:space-y-3">
                              <div className="space-y-1">
                                <div className="font-medium text-mobile-lg">
                                  {s.destination}
                                </div>
                                <div className="text-mobile-sm text-muted-foreground">
                                  {s.state} • {s.region}
                                  ...
                                  <div className="flex flex-wrap gap-1 sm:gap-2">
                                    {s.interestMatch
                                      ...
                                      .map((interest: string, i: number) => (
                                        <span
                                          key={i}
                                          className="text-mobile-xs bg-blue-100 text-blue-800 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-blue-200 shadow-sm"
                                        >
                                          🎯 {interest}
                                        </span>
                                      ))}
                        ...
                        {isExpanded && (
                          <>
                            ...
                            {/* Popup */}
                            <div
                              className={`${getPopupClasses().position} bg-blue-50 border border-blue-200 rounded-lg shadow-2xl p-3 sm:p-4 ${getPopupClasses().width} ${getPopupClasses().height} overflow-y-auto max-w-[95vw] max-h-[95vh]`}
                            >
                              <div className="space-y-2 sm:space-y-3">
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-blue-200 pb-2 gap-3">
                                  <h3 className="font-semibold text-lg sm:text-xl text-blue-800">
                                    {s.destination}
                                  </h3>
                                  <div className="flex items-center gap-2">
                                    {/* Preference Score */}
                                      ...
                                      {s.breakdown.flights && (
                                        <div className="p-2 bg-blue-50 rounded text-sm">
                                          ...
                                          <div className="text-sm font-bold text-blue-900">
                                            ₹
                                            {s.breakdown.flights?.toLocaleString()}
                                          </div>
                                        </div>
                                      )}
                                      {s.breakdown.accommodation && (
                                        <div className="p-2 bg-green-50 rounded text-sm">
                                          ...
                                          <div className="text-sm font-bold text-green-900">
                                            ₹
                                            {s.breakdown.accommodation?.toLocaleString()}
                                          </div>
                                        </div>
                                      )}
                                      {s.breakdown.food && (
                                        <div className="p-2 bg-orange-50 rounded text-sm">
                                          ...
                                          <div className="text-sm font-bold text-orange-900">
                                            ₹
                                            {s.breakdown.food?.toLocaleString()}
                                          </div>
                                        </div>
                                      )}
                                      {s.breakdown.localTransport && (
                                        <div className="p-2 bg-purple-50 rounded text-sm">
                                          ...
                                          <div className="text-sm font-bold text-purple-900">
                                            ₹
                                            {s.breakdown.localTransport?.toLocaleString()}
                                          </div>
                                        </div>
                                      )}
                                      {s.breakdown.attractions && (
                                        <div className="p-2 bg-yellow-50 rounded text-sm">
                                          ...
                                          <div className="text-sm font-bold text-yellow-900">
                                            ₹
                                            {s.breakdown.attractions?.toLocaleString()}
                                          </div>
                                        </div>
                                      )}
                                      {s.breakdown.miscellaneous && (
                                        <div className="p-2 bg-gray-50 rounded text-sm">
                                          ...
                                          <div className="text-sm font-bold text-gray-900">
                                            ₹
                                            {s.breakdown.miscellaneous?.toLocaleString()}
                                          </div>
                                        </div>
                                      )}
                                    </div>
                                ...
                                {s.transportation && (
                                  <div>
                                    ...
                                    {s.transportation.toDestination && (
                                      <div className="p-3 bg-purple-50 rounded text-sm mb-3">
                                        <div className="font-medium mb-1 text-purple-800">
                                          Primary Option:{" "}
                                          {s.transportation.toDestination.mode}
                                        </div>
                                        ...
                                        <div className="text-xs text-muted-foreground mb-1">
                                          Cost: ₹
                                          {s.transportation.toDestination.cost?.toLocaleString()}
                                        </div>
                                        {s.transportation.toDestination
                                          .tips && (
                                          <div className="text-xs text-blue-600 mt-1">
                                    ...
                                    {s.transportation.availableOptions &&
                                      s.transportation.availableOptions.length >
                                        0 && (
                                        <div className="space-y-2">
                                          <div className="text-xs font-medium text-muted-foreground">
                                            All Available Options:
                                          </div>
                                          {s.transportation.availableOptions.map(
                                      ...
                                      {s.samplePlan.attractions
                                        ...
                                        .map((attraction: any, idx: number) => (
                                          ...
                                          >
                                            ...
                                            {/* Interest Match Badges */}
                                            {attraction.interestMatch &&
                                              attraction.interestMatch.length >
                                                0 && (
                                ...
                                {s.samplePlan?.accommodations?.length > 0 && (
                                  <div>
                                    ...
                                    <div className="space-y-2">
                                      {s.samplePlan.accommodations
                                        .slice(0, 3)
                                        .map(
                                          (accommodation: any, idx: number) => (
                                            <div
                                              key={idx}
                                              className="p-2 bg-muted rounded text-sm"
                                            >
                                              ...
                                              {accommodation.accessibilityFeatures &&
                                                accommodation
                                ...
                                {s.samplePlan?.accommodationRoutes?.length >
                                  0 && (
                                  <div>
                                    <h4 className="font-medium text-sm mb-2 text-foreground">
                                    ...
                                    <div className="space-y-2">
                                      {s.samplePlan.accommodationRoutes
                                        .slice(0, 3)
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <Button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        window.open(
                                          `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(s.destination)}, ${encodeURIComponent(s.state)}, India`,
                                          "_blank",
                                        );
                                      }}
                                    >
