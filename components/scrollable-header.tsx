...
export function ScrollableHeader() {
  ...
  return (
    ...
    >
      {/* Main header content */}
      <div
        className={`w-full px-2 sm:px-4 md:px-6 lg:px-8 h-16 sm:h-20 md:h-24 flex items-center justify-between ${
          theme === "dark"
            ? "glass-header-content-dark-medium"
            : "glass-header-content-medium"
        }`}
      >
        <div className="flex items-center overflow-hidden">
          <a
            href="/"
            className="flex items-center justify-center h-full max-w-[120px] sm:max-w-none sm:h-16 sm:w-full ml-2 sm:ml-4 md:ml-25 overflow-hidden"
            title="Happy Journey - Go to Home"
          >
