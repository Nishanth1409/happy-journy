...
export default function ChatDock() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {open && (
        <div
          className={`${getChatSizeClasses().width} ${getChatSizeClasses().height} bg-background/95 backdrop-blur-lg border border-border/50 rounded-lg shadow-2xl overflow-hidden flex flex-col`}
        >
          <div className="flex items-center justify-between px-3 py-2 border-b">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="p-1 hover:bg-muted rounded transition-colors icon-hover-enhanced"
